                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        <a href="?action=view&id='.$appoid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Share link</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
            ...
            <div id="popup1" class="overlay">
                ...
                Client Email  <input type="email" name="email" class="input-text"     value="'.$pemail.'"><br>
                 ...
                 <tr>
                       ...
                       <input type="text" class="input-text" name="message" placeholder"add video link here" value=""><br> 
                        </td>
                        </tr>
                        <tr>
                        <td>

            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-file">
                        <a href="interview.php" class="non-style-link-menu"><div><p class="menu-text">Questionnaires</p></a></div>
                    </td>
                </tr>
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-counselling">
                        <a href="https://riley071.github.io/video-project/" target="_blank" class="non-style-link-menu"><div><p class="menu-text">Live Counselling</p></a></div>
                    </td>
                </tr>

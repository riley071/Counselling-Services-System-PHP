                ...
                <tr>
                    ...
                    <tr>
                        <td >
                            ...
                            <p>Have no idea about counselling? no problem let's jumping to 
                                <a href="doctors.php" class="non-style-link"><b>"All Psychologist"</b></a> section or 
                                <a href="schedule.php" class="non-style-link"><b>"Sessions"</b> </a><br>
                                Track your past and future appointments history.<br>Also find out the expected arrival time of your psychologist or medical consultant.<br><br>
                            </p>
                            
                            <h3>Channel a Psychologist Here</h3>
                            <form action="schedule.php" method="post" style="display: flex">

                                <input type="search" name="search" class="input-text " placeholder="Search  Psychologist and We will Find The Session Available" list="doctors" style="width:45%;">&nbsp;&nbsp;

                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=add-session&id= '.$appoid.'&name='.$pname.'&session='.$title.'&apponum='.$apponum.' &status='.$status.' " class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-glass"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 10px;margin-top: 10px;"><font class="tn-in-text">Status</font>  </br></button></a>&nbsp;&nbsp;
            ...
            <div id="popup1" class="overlay">
                ...
                Client Email  <input type="email" name="email" class="input-text"     value="'.$pemail.'"><br>
                 ...
                 <tr>
                       ...
                       <input type="text" class="input-text" name="message" value="Dear Sir/Madam we would like to inform you that youre appointment has been approved, Please make sure to check with your psychologist!!!"><br> 
                        </td>
                        </tr>
                        <tr>
                        <td>
